...
word = input('Введите окончательное сообщение: ')

print('Бот запущен, теперь ты - "Адский Спамер"')
print('Команды: anim||♥ animation||Anim||♥ Animation.')
print('''P.S. - (Скрипт был разработан при поддержке программистов - "Ok!"
         Наш Discord: https://discord.gg/mxKZtFtMwp)''')

@bot.on_message(filters.regex('anim|♥ animation|Anim|♥ Animation') & filters.me)
...
💛💛""") 
    ...
    bot.edit_message_text(chat_id=message.chat.id, message_id=message.message_id + 1, text=f"""{word} @Yaitismylife""")
